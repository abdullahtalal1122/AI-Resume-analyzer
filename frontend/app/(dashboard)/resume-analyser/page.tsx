...
export default function ResumeAnalyserPage() {
  ...
  return (
    <div className="flex h-full w-full flex-1 flex-col p-2 md:p-10">
      {/* Header */}
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="mt-6 flex gap-4">
          <button
            ...
            className="flex-1 bg-blue-600 text-white py-3 px-6 rounded-md hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed font-medium transition-colors"
          >
      ...
      {result && (
        <div className="space-y-6">
          ...
          {/* Skills */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 text-blue-700">Extracted Skills</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 text-blue-700">Recommended Job Roles</h3>
          ...
          {/* Improvements */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 text-blue-700">Suggested Improvements</h3>
